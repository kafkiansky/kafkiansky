...
- [thesis-php/protoc-plugin](https://github.com/thesis-php/protoc-plugin) ([0.1.10](https://github.com/thesis-php/protoc-plugin/releases/tag/0.1.10), 1 day ago) - PHP plugin for protobuf compiler (protoc).
