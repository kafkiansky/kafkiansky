...
- [prototype-php/byte-buffer](https://github.com/prototype-php/byte-buffer) - A tool to write and read bytes using protobuf serialization encoding (readonly subsplit of monorepo)  (4 days ago)

---

#### Recent Releases

- [typhoon-php/typhoon](https://github.com/typhoon-php/typhoon) ([0.4.2](https://github.com/typhoon-php/typhoon/releases/tag/0.4.2), 1 day ago) - Ultimate type system and reflection for PHP
