...
- [kafkiansky/queues](https://github.com/kafkiansky/queues) -  (3 days ago)
...
- [thesisphp/amqp](https://github.com/thesisphp/amqp) ([0.3.0](https://github.com/thesisphp/amqp/releases/tag/0.3.0), 1 day ago) - Async (fiber based) client for AMQP 0.9.1.
